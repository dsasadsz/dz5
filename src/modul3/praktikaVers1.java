...
//
//
//public class praktikaVers1 {
//    public static void main(String[] args) {
//        // 1. Setup services (could be done via a dependency injection framework)
//        IPayment payment = new CreditCardPayment();
//        IDelivery delivery = new CourierDelivery();
//        INotification notification = new EmailNotification();
//
//        // 2. Create and configure the discount calculator
...
//
//        // 4. Create the main processor with all the required services
...
//                new PostDelivery(),
//                new SmsNotification(),
//                new DiscountCalculator() // No discounts this time
//        );
